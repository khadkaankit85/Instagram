...
const GetChat = () => {
    return (
        <div className="flex flex-col border border-red-600 p-3 w-[100%] h-[100%]">
            <div className="h-[80px]">
                <Link to={"/home/profile"} className="flex justify-between flex-row ">
                    <div className="rounded-[50%] m-1 w-[%] lg:w-[10%] md:w-[100%] flex justify-center">
                    ...
                    <div className="w-[100%] p-5 md:hidden lg:block ">
            ...
            <div className="h-[calc(100%-40px)] border p-2 border-blue-800 text-white overflow-auto">
                <TextMessageSent />
                <TextMessageSent />
                <TextMessageSent />
                <TextMessageSent />
